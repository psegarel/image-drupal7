	...
	<div class="main-container container">
	  ...
	  <header role="banner" id="page-header">
	    ...
	    <?php endif; ?>  
		  ...
		  <?php $single_product_block = block_load('views', 'product-block_2');      
				$single_product = drupal_render(_block_get_renderable_array(_block_render_blocks(array($single_product_block))));
				if(!empty($single_product)){ print $single_product; } ?>
