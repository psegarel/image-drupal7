...
<div class="row">
	...
	<div class="span4">
		<?php 	$suppliers_info_block = block_load('views', 'suppliers-block_1');
				$info = drupal_render(_block_get_renderable_array(_block_render_blocks(array($suppliers_info_block)))); 
				print $info  ?>
	</div>
</div>