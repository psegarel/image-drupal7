...
<section id="main-content">
	<div class="main-container container">
	  ...
	  <header role="banner" id="page-header">
		...
		<div class="row">
			<div class="span8">
			  <?php $about_block = block_load('views', 'about-block');      
					$about = drupal_render(_block_get_renderable_array(_block_render_blocks(array($about_block))));
					if(!empty($about)){ print $about; } ?>
			</div>
		</div>
		<div class="row">
			  <?php $contact_block = block_load('views', 'contact-block');      
					$contact = drupal_render(_block_get_renderable_array(_block_render_blocks(array($contact_block))));
					if(!empty($contact)){ print $contact; } ?>
		</div>
	</div>
</section>
<!-- end Main section -->
